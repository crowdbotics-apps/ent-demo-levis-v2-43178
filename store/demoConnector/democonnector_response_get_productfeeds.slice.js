...
export const democonnector_get_productfeedjson_read = createAsyncThunk(
  "democonnector_response_get_productfeeds/democonnector_get_productfeedjson_read",
  async payload => {
    const response = await apiService.democonnector_get_productfeedjson_read(
      payload
    )
